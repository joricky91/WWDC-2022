...
var foodArr: [FoodModel] = [
    ...
    FoodModel(name: "Kue Cubit", image: "kue-cubit", description: "Kue cubit is one of Indonesian street food, and it is a snack. This food is called kue cubit (pinch) because to eat the cake, we need to pinch it because of the small size. Kue cubit made using flour, baking powder, sugar, and milk. Then the liquid dough is poured into a steel plate with several small round basins so that it will form a round shape when cooked. There are various kue cubit toppings, including chocolate sprinkles, cheese, green tea, and more.", imageFrom: "Image from Pinterest", urlImage: "pinterest.com"),
    FoodModel(name: "Pisang Goreng", image: "pisang-goreng", description: "Pisang Goreng (banana fritter) is a fritter made by deep frying battered banana in hot oil. In Indonesia, pisang goreng if often sold by street vendors, therefore pisang goreng is easy to be found. Pisang goreng might be battered, or just plain deep fried in oil. Pisang goreng is consumed as a snack to accompany tea or coffee, usually for breakfast or afternoon snack.", imageFrom: "Image from Pinterest", urlImage: "pinterest.com")
]
